          ...
          <div className="grid grid-cols-4 gap-7 m-8">
            <Link
              href={
                isConnected
                  ? "/dashboard"
                  : "/registerform/EducationalInstitution"
              }
            >
            ...
            <Link
              href={
                isConnected ? "/dashboard" : "/registerform/GovernmentAgencies"
              }
            >
              <Card className="hover:scale-110 transform transition-transform duration-500">
            ...
            <Link
              href={isConnected ? "/dashboard" : "/registerform/Industries"}
            >
              <Card className="hover:scale-110 transform transition-transform duration-500">
                <CardHeader className="pb-0 flex-col items-center  ">
                  <p className="text-large uppercase font-bold">Industries</p>
                </CardHeader>
            ...
            <Link href={isConnected ? "/dashboard" : "/registerform/Recipient"}>
              <Card className="hover:scale-110 transform transition-transform duration-500">
                <CardHeader className="pb-0 flex-col items-center  ">
                  <p className="text-large uppercase font-bold">Recipient</p>
                </CardHeader>
