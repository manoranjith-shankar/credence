  ...
  const otpHandleSubmit = () => {
    axios
      ...
      .then(function (response) {
        ...
        if(verificationStatus==="approved" && sector === "Educational Instituion" ){
          router.push("/educationdashboard");
        }
        else if(verificationStatus==="approved" && sector === "Government Agencies" ){
          router.push("/governmentdashboard");
        }
        else if(verificationStatus==="approved" && sector === "Industries" ){
          router.push("/industrydashboard");
        }
        else if(verificationStatus==="approved" && sector === "Recipient" ){
        ...
        {!otpRendering ? (
          ...
          <div className="flex justify-center items-center">
            <Input
              ...
              required
            />
            <Button className="m-8 " onClick={otpHandleSubmit} type="submit">
              Submit
            </Button>
          </div>
        )}
